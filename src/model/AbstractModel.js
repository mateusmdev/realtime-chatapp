...
class AbstractModel {
    ...
    async getDocument(data) {
      ...
      const query = await this.#firestore.findById(documentPath, primaryKeyValue)
    ...
    async onSnapshot(callback, constraints = [], path = null, options = null, onError = null) {
